...
function vLesson(day){
  ...
  /* The day's reading sits on this same page: read down through the lesson,
     then the questions are right below it. Nothing else on this page. */
  var body = (EMBED_DOCS && EMBED_DOCS.lessons && EMBED_DOCS.lessons[String(day)]) || "";
  var reading = body
    ? '<div class="docview">' + body + "</div>"
...
function renderQuiz(){
  ...
  var html = '<div class="card"><p class="q-text">How this works</p>' +
    '<p>Read the lesson above, then answer below. Tap the question to see its answers, ' +
